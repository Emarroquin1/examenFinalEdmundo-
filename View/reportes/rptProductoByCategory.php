...
if ($_POST) {
    if (isset($_POST["cmbIdCategoria"])) {
        $categoriaId = $_POST["cmbIdCategoria"];
        ...
        <body>
            ...
            <tr>
                ...
                <td style='width:750%; ' colspan='2'>
                    <h3>REPORTE DE PRODUCTOS SEGUN STOCK DESDE $desde HASTA $hasta</h3>
                </td>
            </tr>
            </table>
            <hr>
            <div>
                <br>
                <p>Alguna informacion descriptiva de los datos .....</p>
                <hr>

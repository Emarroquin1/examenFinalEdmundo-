    ...
    if (isset($_GET["txtCountry"])) {
        ...
        <body>
            ...
            <tr>
                ...
                <h3>REPORTE DE CLIENTES POR EL PAIS DE " . $country . "</h3>
                </td>
            </tr>
            </table>
            <hr>
            <div>
                <br>
                <p>Reporte de Clientes que pertenecen al Pais de " . $country . "</p>
                <hr>
        ...
        $pdf->render();
        $pdf->stream("RPT_Clientes_Por_Pais_De_$country", ['Attachment' => false]);
